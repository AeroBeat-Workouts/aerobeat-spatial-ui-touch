...
func test_dependency_boundary_pins_existing_owners():
	...
	assert_true(helper_expectations.has("AeroSpatialHoverCapturePolicy"))
	...
	assert_string_contains(readme, "does **not** yet claim that the extracted touch provider implementation has landed")
