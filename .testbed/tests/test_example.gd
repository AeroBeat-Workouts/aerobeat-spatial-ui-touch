...
const PROVIDER_CONFIG_SCRIPT_PATH := "res://../src/providers/touch/aero_spatial_ui_touch_provider_config.gd"
const RUNTIME_BOUNDARY_SCRIPT_PATH := "res://../src/providers/touch/aero_spatial_ui_touch_runtime_boundary.gd"
const MANIFEST_SCRIPT_PATH := "res://../src/providers/touch/aero_spatial_ui_touch_manifest.gd"
